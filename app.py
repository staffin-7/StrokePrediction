...
@app.route("/")
def index():
    return render_template("C:/Users/staff/Desktop/Staffin/PROJ/StrokePrediction/Final/templates/home.html")
...
def result():
    ...
    scaler_path=os.path.join('C:/Users/staff/Desktop/Staffin/PROJ/StrokePrediction/Final/','models/scaler.pkl')
    scaler=None
    ...
    model_path=os.path.join('C:/Users/staff/Desktop/Staffin/PROJ/StrokePrediction/Final','models/dt.sav')
